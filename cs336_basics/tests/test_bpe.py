...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({(b"a", b"b"): 4}, (b"a", b"b"), {(b"a", b"b"): 4}, {(b"ab",): 4}, {}),
        ...
        ({(b"a", b"a", b"a"): 1}, (b"a", b"a"), {(b"a", b"a"): 2}, {(b"aa", b"a"): 1}, {(b"aa", b"a"): 1}),
